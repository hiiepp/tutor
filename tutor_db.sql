...
-- Thời gian đã tạo: Th1 15, 2026 lúc 03:15 AM
...
INSERT INTO `classes` (`id`, `tutor_id`, `title`, `subject`, `grade`, `price`, `description`, `method`, `location`, `status`, `max_students`, `created_at`) VALUES
(1, 2, 'Gia sư Toán Lớp 9 lấy gốc', 'Toán', 'Lớp 9', '200000', 'Nhận dạy kèm Toán 9, ôn thi vào 10. Cam kết tiến bộ sau 1 tháng.', 'Offline', 'Quận Gò Vấp', 'active', 1, '2025-12-29 09:16:12'),
(2, 2, 'Luyện thi Đại học môn Lý', 'Vật lý', 'Lớp 12', '300000', 'Chuyên luyện đề Lý 12, mục tiêu 8+.', 'Offline', 'Quận Bình Thạnh', 'active', 1, '2025-12-29 09:16:12'),
(3, 3, 'Tiếng Anh giao tiếp Online', 'Tiếng Anh', 'Lớp 10', '150000', 'Học giao tiếp phản xạ qua Zoom/Google Meet.', 'Online', 'Toàn quốc', 'active', 1, '2025-12-29 09:16:12'),
(4, 3, 'Rèn chữ đẹp cho bé', 'Văn', 'Lớp 1', '120000', 'Cô giáo kiên nhẫn, rèn chữ, tập đọc.', 'Offline', 'Quận 7', 'active', 1, '2025-12-29 09:16:12'),
(5, 2, 'Hóa học nâng cao 11', 'Hóa học', 'Lớp 11', '250000', 'Dạy chuyên sâu Hóa hữu cơ.', 'Offline', 'TP. Thủ Đức', 'active', 1, '2025-12-29 09:16:12'),
(6, 3, 'Toán tư duy cho trẻ em', 'Toán', 'Lớp 3', '180000', 'Phương pháp mới giúp bé tính nhanh.', 'Offline', 'Quận 1', 'active', 1, '2025-12-29 09:16:12'),
(7, 8, 'hiep dep trai', 'Toán', 'Lớp 1', '20000', 'Mô tả: học bao rớt môn\nSố học viên: 5\nLịch học: adsacd\nYêu cầu: ', 'Offline', 'âs', '', 1, '2026-01-07 08:43:58'),
(8, 8, 'ádc', 'Toán', 'Lớp 1', '2000000 VND/Giờ', 'Mô tả: xcƯDVCA\nSố học viên: 1\nLịch học: ACDSƯDA\nYêu cầu: DFCQỪC', 'Offline', 'CÁDC', 'active', 1, '2026-01-13 01:37:44'),
(9, 8, 'a', 'Toán', 'Lớp 1', '200000 VND/Giờ', 'Mô tả: ádc\nSố học viên: 1\nLịch học: \nYêu cầu: 23rf3rq', 'Offline', '', 'hidden', 1, '2026-01-13 04:45:56'),
(10, 8, 'aaâf', 'Toán', 'Lớp 1', '300000 VND/Giờ', 'Mô tả: fff\nSố học viên: 1\nLịch học: \nYêu cầu: ', 'Offline', '', 'active', 1, '2026-01-13 04:50:26'),
(11, 8, 'scasa', 'Lý', 'Lớp 1', '2000000 VND/Giờ', 'Mô tả: casc\nSố học viên: 6\nLịch học: cac\nYêu cầu: wfwer', 'Online', 'asc', 'active', 1, '2026-01-13 09:43:35'),
(12, 11, 'adddaa', 'Toán', 'Lớp 1', '2000000 VND/Giờ', 'Mô tả: âsấ\nSố học viên: 1\nLịch học: ắè\nYêu cầu: ầẻdsf', 'Offline', '10 nguyễn xuân hiệp, Xã Trung Lập Hạ, Huyện Củ Chi, TP. Hồ Chí Minh', 'active', 1, '2026-01-14 07:45:00');
