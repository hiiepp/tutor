...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['avatar']) && $_FILES['avatar']['error'] == 0) {
        ...
        // Đổi tên file để tránh trùng lặp: stu_ID_Timestamp.ext
...
<section class="tutor-dashboard py-5">
  <div class="container" style="max-width: 800px;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div>
          <h4 class="dashboard-title mb-1">Chỉnh sửa hồ sơ</h4>
          <p class="text-muted small mb-0">Cập nhật thông tin cá nhân của bạn</p>
      </div>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="text-center mb-5">
                <div class="d-inline-block profile-avatar-box mb-2">
                    <img id="avatarPreview" src="<?= $avatar_url ?>" class="profile-avatar-img <?= empty($avatar_url) ? 'd-none' : '' ?>">
                    
                    <div id="avatarPlaceholder" class="profile-avatar-circle <?= !empty($avatar_url) ? 'd-none' : '' ?>">
                        <?= $initial ?>
                    </div>
            ...
            <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                <a href="profile.php" class="btn btn-light px-4">Hủy</a>
